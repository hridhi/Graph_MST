...
class Kruskal:
    ...
    def visualize1(self): #for the initial graph 
        ...
        fixed_positions = {1:(1,0),2:(-1,2),3:(1,-3),4:(2,2),0:(-1,-3),4:(3,4)} 
    ...
    def visualize2(self,res): #for the result 
        ...
        for i in range(n):
            ...
            if(res[i][0] not in temp and res[i][1] not in temp):
                ...
                temp.append(res[i][1])
        m=len(temp)
        fixed_positions = {0:(-1,-3),1:(1,0),2:(-1,2),3:(1,-3),4:(3,4)}
        for i in range(m):
...
def kruskal2():
  ...
  #[[0, 1, 2], [1, 2, 3], [1, 4, 5], [0, 3, 6]]
    G.add_edges_from([(0,1),(1,2),(1,4),(0,3)]) 
    p=nx.Graph()
    p.add_edges_from([(0,1),(1,0),(0,3),(1,2),(1,3),(1,4),(2,1),(2,4),(3,0),(3,1),(3,4),(4,1),(4,2)])
    ...
    imageio.mimsave("C:\\Users\\HRIDHI SETHI\\Documents\\openlab\\static\\images\\slowgif12.gif",gif,fps=1)
    return 