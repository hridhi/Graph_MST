...
def prims1():
    ...
    p=nx.Graph()
    p.add_edges_from([(0,1),(0,3),(1,0),(1,2),(1,3),(1,4),(2,1),(2,4),(3,0),(3,1),(3,4),(4,1),(4,2)])
    fixed_positions = {1:(1,0),2:(-1,2),3:(1,-3),4:(2,2),0:(-1,-3)}
    ...
    imageio.mimsave("C:\\Users\\HRIDHI SETHI\\Documents\\openlab\\static\\images\\slowgif5.gif",gif,fps=1)
    return 